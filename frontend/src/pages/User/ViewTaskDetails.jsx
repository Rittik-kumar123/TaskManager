...
const ViewTaskDetails = () => {
  ...
  // console.log(task.todoCheckList);
        ...
        {task && (<div className="grid grid-cols-1 md:grid-cols-4 mt-4">
          <div className="form-card col-span-3">
            ...
            <div className="grid grid-cols-12 gap-4 mt-4">
              ...
              <div className="col-span-6 md:col-span-4">
                <InfoBox label="Due Date" value={task?.dueDate?moment(task?.dueDate).format("Do MMM YYYY"):"N/A"}></InfoBox>
              </div>
              <div className="col-span-6 md:col-span-4">
                <label className="text-xs font-medium text-slate-500">Assigned To</label>
                <AvatarGroup avatars={task?.assignedTo?.map((item)=> item?.profileImageUrl) || []} maxVisible={5}></AvatarGroup>
              </div>
            </div>

            <div className="mt-2">
              <label className="text-xs font-medium text-sky-500">Todo Checklist</label>
...
const Attachment = ({link,index,onClick}) => {
  return <div className="flex justify-between bg-gray-50 border-gray-100 px-3 py-2 rounded-md mb-3 mt-2 cursor-pointer" onClick={onClick}>
